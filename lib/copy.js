...
export const copy = {
  ...
  hero: {
    ...
    trustChips: [
      ...
      { icon: "🛡️", text: "Dnes so zľavou viac ako 75 %" },
    ],
  },

  story: {
    headlinePre: "Cukor je tichý nepriateľ,",
    headlineHighlight: "ktorý ničí vaše zdravie",
    intro:
      "Je prítomný v potravinách, ktoré konzumujete každý deň, ukrytý v potravinách, ktoré vyzerajú úplne neškodne.",
    problemsLead:
    ...
    problems: [
      ...
      "Zrýchlené starnutie",
      "Závislosť na jedle a neustály hlad",
    ],
    solutionHeadline:
  ...
  benefits: {
    ...
    steps: [
      ...
      },
      {
        ...
        desc: "Postupujte podľa jednoduchých pokynov v receptoch a pripravujte úžasná jedia, ktoré od základov premenia vašu stravu.",
      },
      {
        number: "3",
  ...
  features: {
    ...
    categories: [
      {
        ...
        desc: "Recepty na raňajky a desiate, aké ste EŠTE NIKDY nevideli. Rýchle postupy prípravy z praktických a dostupných surovín!",
      },
      {
    ...
    audience: [
      ...
      },
      {
        ...
        desc: "Rodičia, ktorí chcú svojim deťom zabezpečiť výživné a chutné jedlo, a podporovať tak zdravé návyky už od útlého veku.",
      },
      {
  ...
  finalCta: {
    ...
    subUrgency:
      "Nepremeškajte možnosť získať knihu receptov so zľavou viac ako 75 %. Transformujte svoje zdravie hneď teraz s naším kompletným jedálničkom na 365 dní.",
    ...
    discountBadge: "ZĽAVA VIAC AKO 75 %",
    button: "ÁNO, CHCEM RECEPTY + BONUSY HNED TERAZ",
  ...
  faq: {
    ...
    doesntWorkHeadline: "ČO NEFUNGUJE: ❌",
    doesntWork: [
    ...
    items: [
      { q: "AKO DOSTANEM RECEPTY?", a: "Celý obsah vám zašleme priamo na váš e-mail hneď po zaplatení." },
      { q: "MÔŽEM K NIM PRISTUPOVAŤ Z TELEFÓNU?", a: "Áno, môžete k nim pristupovať z telefónu, tabletu alebo počítača." },
      { q: "MÁTE ĎALŠIE OTÁZKY?", a: "Áno, počas celého procesu sa ma môžete priamo pýtať na čokoľvek." },
  ...
  closing: {
    ...
    regularPrice: "40,00 €",
    offerPrice: "8,90 €",
    ctaLabel: "ÁNO, CHCEM RECEPTY + BONUSY HNED TERAZ",
    trustRow:
  ...
  footer: {
    brand: "Crearis",
    copyright: "2026 © Všetky práva vyhradené. Prečítajte si naše Zásady ochrany osobních údajov.",
  },
};